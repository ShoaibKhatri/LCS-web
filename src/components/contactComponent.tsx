    ...
    >
      <div className="container mb-16">
        <div className="mx-auto w-full text-center mb-10">
          ...
          <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl text-blue-50">
            {heading}
          </h2>
        ...
        <div className="">
          ...
          <form className="grid grid-cols-1 gap-6" onSubmit={handleSubmit}>
            ...
            <div className="grid w-full items-center">
              <Label
                htmlFor="email"
                className="mb-2 placeholder-gray-400  text-gray-50 text-[16px]"
              >
                Email
              </Label>
              <Input
            ...
            <div className="mb-3 flex items-center space-x-2 text-sm md:mb-4">
              <Checkbox
                id="terms"
                // className="!text-blue-600 rounded-sm !border !bg-blue-50 !border-blue-50 h-[15px] w-[15px] !focus:ring-blue-50"
